    ...
    <>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto dark:bg-gray-800 shadow-xl">
          ...
          <img src="/rentLogo.png" alt="" className="w-full" />
          </a>
          <ul className="space-y-2 font-medium">
            <li>
              <a
                ...
                className={`flex items-center p-2 rounded-lg group text-[16px] font-regular ${
                  activeMenu === "Dashboard"
                    ? "bg-[#A1E3F9] text-white"
                    : "text-gray-900 dark:text-white hover:bg-[#A1E3F9] hover:text-white dark:hover:bg-gray-700"
                }`}
              >
                <svg
            ...
            <li>
              <a
                ...
                onClick={() => handleMenuClick("RentalManagement")}
                className={`flex items-center p-2 rounded-lg group text-[16px] font-regular ${
                  activeMenu === "Dashboard"
                    ? "bg-[#A1E3F9] text-white"
                    : "text-gray-900 dark:text-white hover:bg-[#A1E3F9] hover:text-white dark:hover:bg-gray-700"
            ...
            <li className="relative group">
              <button className="flex items-center p-2 w-full text-gray-900 rounded-lg dark:text-white hover:bg-[#A1E3F9] hover:text-[#ffffff] dark:hover:bg-gray-700 group text-[16px] font-regular">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
